...
from losses import dice_loss  # Updated import for Dice loss
...
def main(args):
    ...
    criterion = dice_loss  # Using our Dice loss function
    optimizer = optim.Adam(model.parameters(), lr=args.lr)
    print("[INFO] Model, optimizer, and Dice loss set.")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="StridedUNetUpsample with Dice Loss")
    parser.add_argument('--data_root', type=str, default='./data')
    parser.add_argument('--epochs', type=int, default=10)
    parser.add_argument('--batch_size', type=int, default=4)
    parser.add_argument('--lr', type=float, default=1e-4)
    parser.add_argument('--checkpoint_path', type=str, default="checkpoint_upsample.pth")
